...
{
    public partial class LogInEmployeeLoaningShopForm : Form
    {
        List <Event> events;
        int selectedeventId;
        ...
        public LogInEmployeeLoaningShopForm()
        {
            InitializeComponent();
            ...
            command = new MySqlCommand("select EventId,UserId,Title,Description,StartDate,EndDate,TicketPrice,NrTickets,NrSpotsAvailable,CampingSpotPrice,Address from event_;", connection);
            connection.Open();
            ...
            {
                lbEvents.Items.Add(e.Title);
            }

        }

        private void LogInEmployeeLoaningShopForm_Load(object sender, EventArgs e)
        {
        ...
        private void btLogIn_Click(object sender, EventArgs e)
        {
            ...
            string query = "SELECT * FROM user_ WHERE UserId= '" + tbUserId.Text.Trim() + "' and Password_= '" + tbPassWord.Text.Trim() + "'";
            ...
            {
                FormLoaningShop loaningshopform = new FormLoaningShop (selectedeventId);
                loaningshopform.Show();
                this.Hide();
        ...
        {
            Event eventedSearched = SearchEvent(lbEvents.SelectedItem.ToString());
