...
namespace FoodAndDrinkShop
{
    public partial class LogInEmployeeForm : Form
    {
        ...
        private void btLogIn_Click(object sender, EventArgs e)
        {
            ...
            {
                FoodAndDrinksShopForm foodshopform = new FoodAndDrinksShopForm(selectedeventId);
                foodshopform.Show();
                this.Hide();
        ...
        private void lbAvailableEvents_SelectedIndexChanged(object sender, EventArgs e)
        {
