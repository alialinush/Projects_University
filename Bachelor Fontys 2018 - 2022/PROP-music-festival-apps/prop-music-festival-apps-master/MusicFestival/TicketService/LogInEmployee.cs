...
{
    public partial class LogInEmployeeForm : Form
    {
        List<Event> events;
        int selectedeventId;
        ...
        public LogInEmployeeForm()
        {
            ...
            {
                lbAvailableEvent.Items.Add(e.Title);
            }
        }

        private void LogInEmployeeForm_Load(object sender, EventArgs e)
        {
        ...
        private void btLogIn_Click(object sender, EventArgs e)
        {
            ...
            {
                TicketServiceForm ticketserviceform = new TicketServiceForm(selectedeventId);
                ticketserviceform.Show();
                this.Hide();
        ...
        {
            Event eventedSearched = SearchEvent(lbAvailableEvent.SelectedItem.ToString());
